...
"""
ECG-1-2000-std:1
KickvsPunch-1-2000-std:1
NetFlow-1-2000-std:1
UWave-1-2000-std:1
ozone-1-2000- std:0 - 4:4
gesture_phase- 1-2000 std:1 - 4:4 
"""
...
for i in range(10):
    ...
    score=train_eval(X_tr,X_tst,y_tr,y_tst,nb_classes,class_weight,batch_size=8,epochs=2000)
...
X_tr,X_tst,y_tr,y_tst,y_true,nb_classes,class_weight=preprocess(X_train,X_test,y_train,y_test,fac,std=False)
score=evaluate(X_tst,y_tst,nb_classes,"lp3.h5")
